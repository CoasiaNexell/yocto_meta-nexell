					...
					<div class="cbi-section-node">
						<table id="nexell_devs" class="cbi-section-table">
							<tr class="cbi-section-table-titles">
								...
								<th class="cbi-section-table-cell">Temperatures</th>
								<th class="cbi-section-table-cell">Hot</th>
							</tr>
							<tr class="cbi-section-table-descr">
								<th class="cbi-section-table-cell"></th>
								<th class="cbi-section-table-cell"></th>
...
if [ "${nexell_tmp}" != "Socket connect failed: Connection refused" ]; then
	...
	while :;
	do
		nexell_tmp=${nexell_tmp#*Chain ID=}
		nexell_len=${#nexell_tmp}
...
#		nexell_volts=
		...
		nexell_chain_id=${nexell_tmp%%,Num chips=*}
		echo "<td class=\"cbi-value-field\">"
		echo "<div id=\"cbi-table-1-pool\">${nexell_chain_id}</div>"
		echo "<div id=\"cbip-table-1-pool\"></div>"
		echo "</td>"
		
		nexell_asics=${nexell_tmp#*Num active chips=}
		nexell_asics=${nexell_asics%%,Chain skew=*}
		echo "<td class=\"cbi-value-field\">"
		echo "<div id=\"cbi-table-1-url\">${nexell_asics}</div>"
		echo "<div id=\"cbip-table-1-url\"></div>"
		echo "</td>"
		
#		nexell_volts=${nexell_tmp#*Voltage Avg=}
#		nexell_volts=${nexell_volts%%,pllOptimal=*}
#		echo "<td class=\"cbi-value-field\">"
#		echo "<div id=\"cbi-table-1-url\">${nexell_volts}</div>"
#		echo "<div id=\"cbip-table-1-url\"></div>"
#		echo "</td>"
		
		nexell_temps=${nexell_tmp#*Temperatures=}
		nexell_temps=${nexell_temps%%,Enabled chips=*}
		echo "<td class=\"cbi-value-field\">"
		echo "<div id=\"cbi-table-1-url\">${nexell_temps}</div>"
		echo "<div id=\"cbip-table-1-url\"></div>"
		echo "</td>"
		
		nexell_hot_chip=${nexell_tmp#*Temp max=}
		nexell_hot_chip=${nexell_hot_chip%%,Temp min=*}
		echo "<td class=\"cbi-value-field\">"
