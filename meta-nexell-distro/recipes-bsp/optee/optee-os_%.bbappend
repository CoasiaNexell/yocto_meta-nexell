...
SRC_URI_append = " file://0001-optee-os-compile-error-patch.patch"
...
_PATCH_FILE_BY_GEN_="patch -p1 < ${WORKDIR}/0001-optee-os-compile-error-patch.patch -f;"
_PATCH_FILE_REVERT_BY_GEN_="patch -R -p1 < ${WORKDIR}/0001-optee-os-compile-error-patch.patch -f;"
