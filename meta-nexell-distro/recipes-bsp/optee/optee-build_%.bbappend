...
EXTERNALSRC = "${BSP_VENDOR_DIR}/secure/optee/optee_build"
...
PATH_ATF := "${BSP_VENDOR_DIR}/secure/arm-trusted-firmware"
PATH_BL1 := "${BSP_VENDOR_DIR}/bl1/bl1-s5p6818"
PATH_L-LOADER := "${BSP_VENDOR_DIR}/secure/l-loader"
PATH_OPTEE_BUILD := "${BSP_VENDOR_DIR}/secure/optee/optee_build"
PATH_OPTEE_CLIENT := "${BSP_VENDOR_DIR}/secure/optee/optee_client"
PATH_OPTEE_LINUXDRIVER := "${BSP_VENDOR_DIR}/secure/optee/optee_linuxdriver"
PATH_OPTEE_OS := "${BSP_VENDOR_DIR}/secure/optee/optee_os"
PATH_OPTEE_TEST := "${BSP_VENDOR_DIR}/secure/optee/optee_test"
