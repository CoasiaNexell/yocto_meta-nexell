...
do_install_append() {
    ...
    install -m 0644 ${NEXELL_SDK_HEADER_FILE}/videodev2_nxp_media.h ${D}/${SDKPATH}/sysroots/${REAL_MULTIMACH_TARGET_SYS}/usr/include/uapi

    install -d ${D}/${SDKPATH}/sysroots/${REAL_MULTIMACH_TARGET_SYS}/usr/include/KHR
    install -m 0644 ${NEXELL_SDK_HEADER_FILE}/khrplatform.h ${D}/${SDKPATH}/sysroots/${REAL_MULTIMACH_TARGET_SYS}/usr/include/KHR
}
